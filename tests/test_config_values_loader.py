"""Tests for emet.config.values_loader."""
...
from emet.config.values_loader import (
    load_values,
    load_from_template,
    merge_with_defaults,
    save_values,
...
from emet.config.values_schema import OrganizationValues
...
class TestFileWatcher:
    def test_polling_fallback(self, tmp_path):
        ...
        with patch("emet.config.values_loader.FileWatcher._start_watchdog", side_effect=ImportError):
    ...
    def test_watchdog_backend(self, tmp_path):
        ...
        with patch("emet.config.values_loader.FileWatcher._start_watchdog") as mock_wd:
