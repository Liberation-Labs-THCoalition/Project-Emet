"""Tests for emet.memory.spaced module."""
...
def _spaced_patches():
    ...
    return (
        patch.dict(sys.modules, {
            "emet.models.base": MagicMock(MemoryUnit=mock_mu),
            "emet.models": MagicMock(),
        }),
        patch("emet.memory.spaced.select", mock_select),
        patch("emet.memory.spaced.update", mock_update),
    )
