"""Comprehensive tests for emet.adapters.slack - Slack Bot adapter.
...
from emet.adapters.slack import (
    # Core adapter
    SlackAdapter,
    SlackConfig,
    # Event handlers
...
from emet.adapters.shared import (
    AdapterPlatform,
    AdapterMessage,
    AdapterResponse,
    PairingManager,
...
class MockPairingManager:
    ...
    def _do_generate_code(
        ...
        if platform_user_id in self._attempts:
            ...
            if len(recent) >= self._config.max_attempts_per_hour:
                from emet.adapters.shared import RateLimitExceeded
    ...
    def approve(self, code: str, approver: str) -> PairingCode:
        ...
        if pairing_code is None:
            from emet.adapters.shared import CodeNotFound
...
class TestOAuthHandler:
    ...
    def handler(self):
        ...
        return OAuthHandler(
            ...
            redirect_uri="https://emet.ai/slack/oauth/callback",
        )
    ...
    def test_creation_with_credentials(self, handler):
        ...
        assert handler.redirect_uri == "https://emet.ai/slack/oauth/callback"
