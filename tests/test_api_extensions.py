"""Tests for emet.api.websocket and emet.api.middleware modules."""
...
from emet.api.websocket import ConnectionManager, MessageType
...
def _make_app():
    ...
    from emet.api.middleware import (
        AuthMiddleware,
