"""Tests for emet.memory.significance module."""
...
class TestExpiredMemoryReaper:
    ...
    async def test_reap_no_expired(self):
        ...
        with patch.dict(sys.modules, {"emet.models.base": MagicMock(MemoryUnit=mock_mu), "emet.models": MagicMock()}), \
             patch("emet.memory.significance.select", mock_select), \
             patch("emet.memory.significance.update", mock_update):
