"""Tests for emet.memory.temporal module."""
...
from emet.memory.temporal import Category, TemporalEvent, TemporalLog
...
class TestTemporalLogQuery:
    ...
    async def test_query_events_basic(self):
        ...
        with patch("emet.memory.temporal.select") as mock_select:
            mock_stmt = MagicMock()
