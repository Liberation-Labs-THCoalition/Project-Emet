"""Tests for emet.memory.cold_archive module."""
...
from emet.memory.cma_stage1 import Turn, Window
...
class TestArchiveWindow:
    ...
    async def test_archive_window_returns_id(self):
        ...
        with patch.dict("sys.modules", {"emet.models.base": mock_base, "emet.models": MagicMock()}):
            ca = ColdArchive()
...
class TestRetrieveArchive:
    ...
    async def test_retrieve_decompresses(self):
        ...
        with patch("emet.memory.cold_archive.select") as mock_select:
            mock_stmt = MagicMock()
...
class TestVerifyIntegrity:
    ...
    async def test_all_pass(self):
        ...
        with patch("emet.memory.cold_archive.select") as mock_select:
            ...
            with patch.dict("sys.modules", {"emet.models.base": MagicMock(), "emet.models": MagicMock()}):
                ca = ColdArchive()
