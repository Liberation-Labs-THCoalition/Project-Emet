...
Example usage::
    ...
    from emet.adapters.slack import SlackAdapter, SlackConfig
    from emet.adapters.discord import DiscordAdapter, DiscordConfig
    from emet.adapters.webchat import WebChatHandler, WebChatConfig
    from emet.adapters.email import EmailAdapter, EmailConfig
