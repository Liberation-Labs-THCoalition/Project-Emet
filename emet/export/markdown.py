...
class MarkdownReport:
    ...
    def generate_from_engine_result(
        ...
        report.caveats = [
            ...
            "Network analysis identifies structural patterns — it does not prove wrongdoing.",
    ...
    def _graph_findings_section(self, findings: dict[str, Any]) -> str:
        ...
        if cycles:
            lines.append("### ⚠️ Circular Ownership Detected\n")
            for cycle in cycles:
                entities_str = " → ".join(cycle.get("entities", []))
                lines.append(
    ...
    def _timeline_section(self, events: list[dict[str, Any]]) -> str:
        ...
        for event in sorted_events[:50]:  # Cap at 50 events
            ...
            lines.append(f"- **{date}** — {prefix}{description}")
    ...
    def _caveats_section(self, caveats: list[str]) -> str:
        ...
        default_caveats = [
            ...
            "Graph analysis identifies structural patterns — not evidence of wrongdoing.",
        ]
